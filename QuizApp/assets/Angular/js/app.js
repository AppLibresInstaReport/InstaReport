 ...
 */
    .constant('CHARTS', {
        ...
        discreteBarChart: { path: '/discreteBarChart', title: 'Tipo de Pruebas', plunker: 'http://plnkr.co/edit/6t5bky?p=preview' },
        ...
        pieChart: { path: '/pieChart', title: 'Usuarios', plunker: 'http://plnkr.co/edit/vtKWU0?p=preview' },
        ...
        donutChart: { path: '/donutChart', title: 'Materias', plunker: 'http://plnkr.co/edit/jOoJik?p=preview' },
